...
<!--
  このテンプレートは docs-site/docs/ 配下の各ラボドキュメントの雛形です。
...
<!-- ============================================================
  セクション: ハンズオン手順
  ※ ハンズオン手順とラボ体験UIは「実際に試す」ページ（*-tryit.mdx）に分離しました。
  ※ テンプレート: _TEMPLATE_TRYIT.md を参照してください。
============================================================ -->
...
| DB (該当する場合) | `.devcontainer/db/init.sql` に [テーブル名] を追加 |
...
| ラボ | 関連性 |
|------|--------|
| [関連ラボ名](../../stepXX-xxx/yyy/yyy.md) | [どう関連するかの説明。例: 「XSSで盗んだCookieを使ってセッションハイジャックを行える」] |
