---
title: Race Condition (TOCTOU) — チェックと処理のタイミング差を悪用して制約を回避する
sidebar_position: 3
---
...
| ラボ | 関連性 |
|------|--------|
| [SQL インジェクション](../step02-injection/sql-injection) | どちらも DB 操作に関わる脆弱性。SQL インジェクションはクエリの改ざん、レースコンディションはクエリの実行順序の問題 |
