...
| ラボ | 関連する知識 |
|------|--------------|
| [セッションハイジャック](../../step04-session/session-hijacking/session-hijacking.mdx) | セッションIDの要件、Cookie属性 |
| [セッション固定攻撃](../../step04-session/session-fixation/session-fixation.mdx) | セッションIDの管理 |
| [Cookie操作](../../step04-session/cookie-manipulation/cookie-manipulation.mdx) | Cookie属性の理解 |
| [CSRF](../../step04-session/csrf/csrf.mdx) | Cookieの自動送信、SameSite属性 |
