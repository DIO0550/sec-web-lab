...
| ラボ | 関連する知識 |
|------|--------------|
| [平文パスワード保存](../../../step03-auth/plaintext-password/plaintext-password.mdx) | ハッシュ関数によるパスワード保護の重要性 |
| [デフォルト認証情報](../../../step03-auth/default-credentials/default-credentials.mdx) | 認証とBasic認証の仕組み |
