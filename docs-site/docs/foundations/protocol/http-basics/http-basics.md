...
| ラボ | 関連する知識 |
|------|--------------|
| [HTTPレスポンスヘッダーからの情報漏洩](../../../step01-recon/header-leakage/header-leakage.mdx) | HTTPレスポンスヘッダの構造、公開性 |
| [不要なヘッダー露出](../../../step01-recon/header-exposure/header-exposure.mdx) | セキュリティヘッダの役割 |
| [エラーメッセージからの情報漏洩](../../../step01-recon/error-message-leakage/error-message-leakage.mdx) | ステータスコードとエラーメッセージの扱い |
...
- [HTTPの基礎 - 理解度テスト](./http-basics-quiz)
