---
title: ログインジェクション --- ユーザー入力でログを改ざんする
sidebar_position: 4
---
...
| [XSS (クロスサイトスクリプティング)](../step02-injection/xss) | ログビューアーがブラウザで表示される場合、ログに注入された JavaScript が XSS として実行される可能性がある (Stored XSS via Log) |
