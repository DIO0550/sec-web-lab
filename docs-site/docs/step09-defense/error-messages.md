---
title: 詳細エラーメッセージ露出 — デバッグ情報がそのまま攻撃者の手がかりになる
sidebar_position: 1
---
...
| [エラーメッセージからの情報漏洩](../step01-recon/error-message-leakage) | Step 01 の偵察ラボで扱ったエラーメッセージ漏洩の防御版 |
| [SQL Injection](../step02-injection/sql-injection) | 詳細エラーメッセージから得たテーブル構造の情報が SQL インジェクション攻撃を容易にする |
