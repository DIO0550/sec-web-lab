...
| ラボ | 関連性 |
|------|--------|
| [スタックトレース漏洩](../stack-trace/stack-trace.mdx) | エラーメッセージの一種としてスタックトレースが漏洩するケース。本ラボではより広範な情報漏洩を扱う |
| [エラーメッセージからの情報漏洩](../../step01-recon/error-message-leakage/error-message-leakage.mdx) | Step 01 の偵察ラボで扱ったエラーメッセージ漏洩の防御版 |
| [SQL Injection](../../step02-injection/sql-injection/sql-injection.mdx) | 詳細エラーメッセージから得たテーブル構造の情報が SQL インジェクション攻撃を容易にする |
...
[→ 実際に試す](./error-messages-tryit.mdx)
...
- [詳細エラーメッセージ露出 - 理解度テスト](./error-messages-quiz.mdx)
