...
| ラボ | 関連性 |
|------|--------|
| [SSRF](./ssrf.mdx) | 本ラボの前提。基本的なSSRFの仕組みと対策を理解した上で、その対策の回避手法を学ぶ |
| [XXE](./xxe.mdx) | XXEの外部エンティティ参照でもSSRFと同等の内部アクセスが可能であり、同様のフィルタ回避テクニックが適用できる |
...
- [SSRFフィルタ回避 - 理解度テスト](./ssrf-bypass-quiz)
