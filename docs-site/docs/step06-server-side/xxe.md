---
title: XXE (XML External Entity) — XML外部エンティティによるファイル読み取り
sidebar_position: 2
---
...
| [SQLインジェクション](../step02-injection/sql-injection) | XXEもSQLiも「ユーザー入力がコードとして解釈される」という共通の根本原因を持つ。XXEではXMLのDTD構文、SQLiではSQL構文 |
